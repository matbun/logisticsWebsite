...
if(isset($_POST['aggiungi_comm'])){
	...
	$sql = "INSERT INTO `retailers` (`retailer_id`, 
								   `nome`, 
								   `proprietario`, 
								   `tel`, 
								   `mail`,
	...
	if($result = mysqli_query($link, $sql)){
		//the query went well
	    $result = "<p>Commerciante inserito correttamente!</p>";
	} 
	else{
...
<body>
	...
	<form action="new_retailer.php" method="post">
	    <input name="nome" type="text" placeholder="Nome" autofocus required ><br>
	    <input name="proprietario" type="text" placeholder="Proprietario (nome completo)" required ><br>
	    ...
	    <input type="submit" id="submit" name="aggiungi_comm" value="Aggiungi commerciante">
	</form>
